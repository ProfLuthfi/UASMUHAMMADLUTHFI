    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col col-sm-9"> Entry Data SKill </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sample_form').on('submit', function(event) {
                ...
                if ($('#action').val() == "Add") {
                    ...
                    $.ajax({
                        url: "http://localhost/oop/api/skills/createskill.php",
                        method: "POST",
                    ...
                    $.ajax({
                        url: "http://localhost/oop/api/skills/updateskill.php",
                        method: "PUT",
                        data: JSON.stringify(formData),
                        success: function(data) {
                            $('#action_button').attr('disabled', false);
        ...
        function showAll() {
            $.ajax({
                ...
                url: "http://localhost/oop/api/skills/readskill.php",
        ...
        function showOne(id) {
            ...
            $.ajax({
                type: "GET",
                contentType: "application/json",
                url: "http://localhost/oop/api/skills//readskill.php?id=" + id,
                success: function(response) {
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url: "http://localhost/oop/api/skills/deleteskill.php",
                method: "DELETE",
                data: JSON.stringify({
                    "id_skill": id
                }),
